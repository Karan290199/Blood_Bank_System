...
if (isset($_POST['submit'])) {
	...
	elseif (empty($Password)) {
		...
		$Pass = mysqli_query($conn,"select Password from admin where Name='$Name'");
...
<body id="bgimg">
	<div class="container">
		<div class="login-form col-md-4 offset-md-4">
			<div class="jumbotron">
				<h2 class="text-center">Admin Form</h2><br>
				<form method="post">
					<div class="form-group">
						<label>Username: </label>
						<input type="text" name="Name" placeholder="Enter your Name" class="form-control" value='<?php echo $Name ?>'><?php echo $msg1 ?><br>
